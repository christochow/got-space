    ...
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<BlocState> state) {
        ...
        return Scaffold(
            ...
            body: Center(
              child: Text(
                  'Rating: ' + state.data.snapshot.data['rating'].toString()),
            ));
//      return ListView(
//        children: state.subSections.map((e) {
//          return BlocProvider<SubSectionBloc>(
//            create: (context) =>
//                SubSectionBloc(FirebaseRepository(FirebaseClient()), e.documentID,
//                    'widget.path' + '/floors/'),
//            child: FlatButton(child: Text(e.documentID+':'+e.data['rating']),
//              onPressed: () {
